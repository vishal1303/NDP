...
hw_histogram_from_file(keys, "disaggregated_0.10.tput.avg", load_path, "disaggregated_0_10_tput", "Application", "Throughput (Gbps)", label_replacer=label_replacer)
