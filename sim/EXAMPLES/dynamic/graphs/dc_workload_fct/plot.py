...
keys = [('orange', 'Shoal(4-uplinks)'), ('dodgerblue', 'Shoal(2-uplinks)'), ('crimson', 'Shoal(1-uplink)'), ('turquoise', 'DCTCP'), ('rosybrown', 'DCQCN'), ('black', '100G')]
hw_histogram_from_file(keys, "dc_workload.fct.99.9", load_path, "dc_workload_fct", "Load", "99.9-perc. FCT (us)")
