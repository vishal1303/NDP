...
hw_histogram_from_file(keys, "disaggregated_0.25.fct.99.9", load_path, "disaggregated_0_25_fct", "Application", "99.9-perc. FCT (us)", label_replacer=label_replacer)

#keys = [('crimson', 'Shoal'), ('dodgerblue', 'DCTCP'), ('orange', 'DCQCN'), ('turquoise', 'NDP')]
#label_replacer = {'BDB': 'Big Data\nBenchmark', 'Wordcount-Spark': 'Wordcount\nSpark', 'Terasort-Spark': 'TeraSort\nSpark', 'Terasort-Hadoop': 'TeraSort\nHadoop', 'Wordcount-Hadoop': 'Wordcount\nHadoop'}
#hw_histogram_from_file(keys, "disaggregated_0.25.fct.99.9.100g", load_path, "disaggregated_0_25_fct_100g", "Application", "99.9-perc. FCT (us)", label_replacer=label_replacer)
