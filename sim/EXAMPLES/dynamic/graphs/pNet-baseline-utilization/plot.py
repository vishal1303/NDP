...
def plot_line_graph(graphs_path,keys,fname,title,y_label,xaxis="Bandwidth (Gbps)", xtransform=None,x_lim=0, dcqcn=False):
  plt.clf()
  plt.rcdefaults()
  i = 0
  ...
  for key in keys:
    ...
    #    plt.axvline(2, ymax=0.8, color="k", linestyle="--", linewidth=2)
    #line1, = plt.plot([0],label="Maximum", linestyle='--',color='k', linewidth=2)
    #line2, = plt.plot([0],'ro',label="Shoal",ms=9)
    #first_legend = plt.legend(handles=[line1,line2],loc=4,fontsize=24)
    ...
    if i < 2:
        ...
        #line3[i], = plt.plot(x,[v for v in y],'ro',ms=9)
...
Keys = [""]
plot_line_graph(load_path,Keys,["ndp_debug.utilization"],"NDP_UTILIZATION","Network Utilization (%)",xaxis="Time (ms)", xtransform=None, x_lim=50)
plot_line_graph(load_path,Keys,["dctcp_debug.utilization"],"DCTCP_UTILIZATION","Network Utilization (%)",xaxis="Time (ms)", xtransform=None, x_lim=50)
plot_line_graph(load_path,Keys,["dcqcn_debug.utilization"],"DCQCN_UTILIZATION","Network Utilization (%)",xaxis="Time (ms)", xtransform=None, x_lim=50, dcqcn=True)
plot_line_graph(load_path,Keys,["pfabric_debug.utilization"],"pFabric_UTILIZATION","Network Utilization (%)",xaxis="Time (ms)", xtransform=None, x_lim=50)
