...
do
    ...
    do
        ...
        echo "python workload/dc_workload/plot/skew_sensitivity.py ${workload} ${protocol}"
        python workload/dc_workload/plot/skew_sensitivity.py ${workload} ${protocol}
    done
done
